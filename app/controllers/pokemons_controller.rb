class PokemonsController < ApplicationController
  ...
  private
    ...
    def pokemon_params
      params.require(:pokemon).permit(:name, :desc, :height, :weight, :category, :ability, :type, :weakness, :hp, :attack, :defence, :special_attack, :special_defence, :speed, :image_url_large, :image_url_small)
    end
end
